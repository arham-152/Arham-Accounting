      ...
      <div className="w-full sm:w-auto flex justify-between items-center sm:shrink-0">
        <div className="flex items-center gap-3">
          <div className="h-10 flex items-center justify-center">
            {isDarkMode ? (
              <img src="logo-dark.png" alt="Account" className="h-full w-auto object-contain" referrerPolicy="no-referrer" onError={(e) => (e.currentTarget.style.display = 'none')} />
            ) : (
              <img src="logo-light.png" alt="Account" className="h-full w-auto object-contain" referrerPolicy="no-referrer" onError={(e) => (e.currentTarget.style.display = 'none')} />
            )}
          </div>
